...
// import { createOrder, getMyOrders, getAllOrders, updateOrderStatus } from './service';
// import { sendSuccess, sendError } from '../../utils/response';
...
//       sendError(res, 'orderType must be "dine-in" or "take-away"', 400);
//       return;
//     }
//     if (!["upi", "cash"].includes(paymentMethod)) {
//       sendError(res, 'paymentMethod must be "upi" or "cash"', 400);
//       return;
//     }
...
// import { Response } from 'express';
// import { AuthRequest } from '../../middleware/auth.middleware';
// import { createOrder, getMyOrders, getAllOrders, updateOrderStatus, notifyOrderReady } from './service';
// import { sendSuccess, sendError } from '../../utils/response';
...
export const notifyUser = async (
  ...
  try {
    ...
    sendSuccess(res, "Order ready notification sent to customer");
  } catch (error) {
    const message =
